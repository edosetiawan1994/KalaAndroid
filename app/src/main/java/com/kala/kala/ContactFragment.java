...
public class ContactFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // create self contact
            ...
            String selfName = pref.getString("name", "no name found");
            String selfUsername = pref.getString("username", "no username found");
            String selfEmail = pref.getString("email", "no email found");
            String selfPhone = pref.getString("phone", "no phone found");
        ...
        contacts.add(0, new ContactHeader("Friends"));
//        edit this into self profile
        contacts.add(1, new Contact(R.drawable.profilepicture, selfName, selfUsername, selfEmail, selfPhone));
        contacts.add(2,new ContactHeader("Contacts"));
