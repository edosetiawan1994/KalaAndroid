...
import com.kala.kalamodel_android_library.Model.Contact;
import com.kala.kalamodel_android_library.Model.GroupModel;
import com.kala.kalamodel_android_library.Model.ReminderModel;
import com.kala.kalamodel_android_library.Model.Schema.User.User;
import com.kala.kalamodel_android_library.Model.UserModel;
...
public class ModelManager {
    ...
    public void login(final String email, final String password, final Callback<String> callback) {
        new Thread() {
            @Override
            public void run() {
